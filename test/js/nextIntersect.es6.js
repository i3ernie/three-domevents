...
function logEvent( ev ){
    console.log( "eventListener: " + ev.type + " for " + ev.target.name + " <--on-- ", ev.intersect.object.name, this );
}
function logOnClick( ev ){
    console.log( ev.target.name + ".onClick: intersect ", ev.intersect.object.name );
}
